...
export class QuestionResolverBase {
  ...
  async createQuestion(
    ...
    return await this.service.createQuestion({
      ...
      data: {
        ...
        examBoard: args.data.examBoard
          ? {
              connect: args.data.examBoard,
            }
          : undefined,
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [UserPerformance], { name: "userPerformances" })
  @nestAccessControl.UseRoles({
  ...
  async findUserPerformances(
    ...
    const results = await this.service.findUserPerformances(parent.id, args);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => ExamBoard, {
    nullable: true,
    name: "examBoard",
  })
  @nestAccessControl.UseRoles({
  ...
  async getExamBoard(
    ...
    const result = await this.service.getExamBoard(parent.id);
  ...
  async getTopic(@graphql.Parent() parent: Question): Promise<Topic | null> {
