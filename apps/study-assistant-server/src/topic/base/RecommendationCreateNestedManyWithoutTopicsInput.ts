...
@InputType()
class RecommendationCreateNestedManyWithoutTopicsInput {
...
export { RecommendationCreateNestedManyWithoutTopicsInput as RecommendationCreateNestedManyWithoutTopicsInput };
